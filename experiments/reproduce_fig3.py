...
def reproduce_fig3(path="/data_cytometry"):
    ...
    DAG_SEARCH = CoDAGType.MSS # or SKIP
    ...
    for confounder_i, confounder in [(8,8)]: # enumerate(nodes_true):
        ...
        coco = CoCo(G_observed, Dc, CONFOUNDING_TEST,  SHIFT_TEST, DAG_SEARCH,
                    sampler=Sampler(), n_components=1, dag=None, node_nms=nms, alpha_shift_test=ALPHA_SHIFT_TEST)
