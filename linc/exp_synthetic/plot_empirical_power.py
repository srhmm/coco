        ...
        for g_var, (lb, ub), ax in zip(grid_vars, indices, row):
            ...
            plot_df_ax = pd.concat(
                (
                    ...
                    plot_df_ax[(plot_df_ax[r'$\bf{Score}$'] == 'Hard') & (plot_df_ax[r'$\bf{Test}$'] == 'LINC')],
                    plot_df_ax[(plot_df_ax[r'$\bf{Score}$'] == 'Soft') & (plot_df_ax[r'$\bf{Test}$'] == 'LINC')]
                ),
                ignore_index=True
            )
            if SIMPLIFIED:
                plot_df_ax = pd.concat(
                    (
                        plot_df_ax[
                            (plot_df_ax[r'$\bf{Score}$'] == 'Soft') & (plot_df_ax[r'$\bf{Test}$'] == 'MSS (KCI)')],
                        plot_df_ax[(plot_df_ax[r'$\bf{Score}$'] == 'Hard') & (plot_df_ax[r'$\bf{Test}$'] == 'LINC')],
                        plot_df_ax[(plot_df_ax[r'$\bf{Score}$'] == 'Soft') & (plot_df_ax[r'$\bf{Test}$'] == 'LINC')]
                    ),
                    ignore_index=True
...
# for row, metric in zip(axes, ['Recall', 'Precision', 'Average precision']):
    for g_var, (lb, ub), ax in zip(grid_vars, indices, row):
        plot_df_ax = plot_df[
                (plot_df['params_index'] >= lb)
                & (plot_df['params_index'] < ub)
                & (plot_df[r'$\bf{Test}$'].isin(['MSS (KCI)', 'MSS (GAM)', 'MSS (FisherZ)', 'LINC']))#, 'MC']))
        ]
