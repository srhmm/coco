...
def gen_context_data(C_n, D_n, node_n, seed,
                     ...
                     node_density=.5, scale=True,  iv_in_groups=True, vb=False,
    ...
    :param node_density: density of connections in DAG
    ...
    if vb:
        ...
        print("\nTARGET Y =", target)
        for p in dag.nodes:
            if iv_type_target == IvType.CONFOUNDING:
